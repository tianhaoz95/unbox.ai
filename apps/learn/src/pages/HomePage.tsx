...
const chapters = [
  ...
  },
  {
    ...
    color: "#f59e0b",
    icon: "💬",
    desc: "Turn a base model into an instruction follower. Chat templates, TRL SFTTrainer, and dataset formatting.",
    topics: ["Chat templates", "SFTTrainer", "LoRA / PEFT", "Instruction datasets"],
  },
  {
    num: "05",
    ...
    color: "#ec4899",
    icon: "🏆",
    desc: "RLHF, DPO, GRPO — align the model with human preferences and verifiable rewards.",
    topics: ["DPO", "GRPO / RLVR", "Reward modeling", "PPO with OpenRLHF"],
  },
  {
    num: "06",
    title: "Inference",
